...
void get_matrix_par_c(double ** matrix_a, double ** matrix_c, int lin, int col,int T){
	#pragma omp parallel for num_threads(T) collapse(2)
    for (int i = 0; i < lin; i++) {
		for (int j = 0; j < col; j++) {
			if (i == j) {
...
void get_matrix_par_g(double ** matrix_a, double ** matrix_b, double ** matrix_g, int lin,int T){
...
void apply_jacobi_par(double ** matrix_c, double ** matrix_g, double ** matrix_x, double ** matrix_x0,int N,int T){
	while (1 == 1) {
...
void equacao_par(double ** matrix_a, double ** matrix_b, double ** matrix_x,int N,int T){
	int n,i;
